...
- Some filenames depend on the version and will be slightly different from the provided examples.
...
- **Bootloader**: A program that starts up the main operating system when you start your phone.
- **Distribution**: A specific version of Linux.
...
1. Connect your phone to your computer with USB cable and copy `init_boot_X-FLASH-ALL-88DF.img` to your phone.
2. In the Magisk app, select "Install" then "Select and Patch a File" and find the boot image you copied from earlier, then select "Let's Go".
3. Once the image is patched it should create a file called `magisk_patched.img`  and copy it back to your computer's Downloads folder.
...
2. My phone isn't detected by my computer!!
	1. Enable file transfers through the notification on your phone
	2. Try a different port/cable
3. My phone doesn't start any more!!
