...
3. Once the image is patched it should create a file similar to `magisk_patched.img` and copy it back to your computer's Downloads folder.
...
2. `some command` doesn't work!
	- You might have forgotten to replace parts of the command.
